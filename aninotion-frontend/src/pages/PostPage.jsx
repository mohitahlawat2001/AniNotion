  ...
  if (!post) {
    return (
      <div className="text-center py-12">
        ...
        <button
          onClick={() => navigate('/')}
          className="btn-primary hover:bg-gray-200 px-4 py-2 rounded-lg cursor-pointer"
        >
          Go back home
        </button>
      </div>
  ...
  return (
    <section className="max-w-[96%] mx-auto">
      <div className="flex justify-end md:justify-start">
        <button
          onClick={() => navigate(-1)}
          className="flex items-center space-x-2 mb-6 bg-black/20 backdrop-blur-sm shadow hover:shadow-md hover:shadow-blue-500 text-black hover:text-gray-50 hover:bg-gray-900 px-4 py-2 rounded-full transition-all duration-300 border border-white/30 group cursor-pointer"
        >
      ...
      <div className="">
        ...
        <div className="flex flex-col lg:flex-row gap-4 lg:gap-8">
          {/* Main Post Content */}
          <div className="flex-1 max-w-none lg:max-w-3xl relative rounded-lg shadow-lg hover:shadow-blue-500 transition duration-200">
            ...
            <article className="bg-white rounded-lg shadow-md overflow-hidden">
                      ...
                      <div className="absolute bottom-2 sm:bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-1 sm:space-x-2">
                        {images.map((_, index) => (
                          <button
                            ...
                            className={`w-2 h-2 sm:w-3 sm:h-3 rounded-full transition-colors touch-target ${index === currentImageIndex
                              ? 'bg-white'
              ...
              <div className="p-4 sm:p-6 lg:p-8">
                ...
                <div className="flex items-center justify-between mb-3 sm:mb-4">
                  <span className="inline-flex items-center py-1 rounded-full text-sm md:text-base font-medium bg-primary/10 text-primary">
                    <Tag size={20} className="mr-1 sm:hidden" />
                    <Tag size={24} className="mr-1 hidden sm:block" />
                    {post.category?.name}
                  </span>
                    ...
                    <div className="flex items-center space-x-2">
                      {canEditPost() && (
                        <button
                          ...
                          className="flex items-center space-x-1 px-3 py-1.5 text-sm md:text-base text-blue-600 hover:text-blue-700 hover:bg-blue-50 rounded-lg transition-colors cursor-pointer"
                          title="Edit post"
                        >
                          <Edit size={14} />
                      ...
                      {canDeletePost() && (
                        <button
                          ...
                          className="flex items-center space-x-1 px-3 py-1.5 text-sm md:text-base text-red-600 hover:text-red-700 hover:bg-red-50 rounded-lg transition-colors cursor-pointer"
                          title="Delete post"
                        >
                          <Trash2 size={14} />
          ...
          <div className="w-full lg:w-80 mt-6 lg:mt-0">
            <div className="bg-white min-h-[287px] rounded-lg p-4 sm:p-6 shadow-lg hover:shadow-blue-500 transition duration-200 group">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">
                Recommended Posts
              </h3>
              <div className="flex flex-col gap-2 items-center justify-center text-gray-600 text-center py-8">
        ...
        {post?.animeName && (
          <div className="mt-8 lg:mt-12">
            <div className="bg-white rounded-xl shadow-lg hover:shadow-blue-500 transition duration-200 overflow-hidden border border-gray-100">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          ...
                          {animeDetails.status && (
                            <div className="flex justify-between items-center py-2 border-b border-gray-200">
                              ...
                              <span className={`px-2 py-1 rounded-full text-xs font-medium ${animeDetails.status === 'finished_airing' ? 'bg-green-100 text-green-800' :
                    ...
                    <div className="mb-8">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {animeDetails.genres.map((genre, index) => (
                          <span
                            key={genre.id}
                            className={`px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 hover:scale-105 ${index % 6 === 0 ? 'bg-blue-100 text-blue-800 hover:bg-blue-200' :
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        {searchResults.slice(0, 6).map((anime) => (
                          <button
                            ...
                            className={`text-left p-4 rounded-xl border-2 transition-all duration-200 hover:shadow-lg ${selectedAnimeId === anime.node.id
